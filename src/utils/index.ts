...
export function getEnvBaseUrl() {
  ...
  if (isMpWeixin) {
    ...
    switch (envVersion) {
      case "develop":
        baseUrl =
          import.meta.env.VITE_SERVER_BASEURL__WEIXIN_DEVELOP || baseUrl;
        break;
      case "trial":
      ...
      case "release":
        baseUrl =
          import.meta.env.VITE_SERVER_BASEURL__WEIXIN_RELEASE || baseUrl;
        break;
    }
  }
...
export function getEnvBaseUploadUrl() {
  ...
  if (isMpWeixin) {
    ...
    switch (envVersion) {
      case "develop":
        baseUploadUrl =
          import.meta.env.VITE_UPLOAD_BASEURL__WEIXIN_DEVELOP || baseUploadUrl;
        break;
      case "trial":
        baseUploadUrl =
          import.meta.env.VITE_UPLOAD_BASEURL__WEIXIN_TRIAL || baseUploadUrl;
        break;
      case "release":
        baseUploadUrl =
          import.meta.env.VITE_UPLOAD_BASEURL__WEIXIN_RELEASE || baseUploadUrl;
        break;
    }
  }
...
export function isNotEmpty<T>(data: T) {
