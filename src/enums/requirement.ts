...
export const craftManRequirementStatusText = {
  ...
  [RequirementStatus.GroupCodeUploaded]: {
    crafeman: "已建群",
    user: "已建群",
    detail: "请尽快加入项目群沟通",
    bgColor: "#3789fe",
  },
  [RequirementStatus.GroupConnecting]: {
    crafeman: "群内对接",
    user: "群内对接",
    detail: "群内对接中",
    bgColor: "#f6590d",
  },
  [RequirementStatus.WasCanceled]: {
    crafeman: "工单已取消",
    user: "工单已取消",
    detail: "工单已取消",
    bgColor: "#e1e1e1",
...
export const jobStateNoticeInfo = {
  [RequirementStatus.GroupCodeUploaded]: {
...
export enum RequirementStatusByUser {
  "工匠待抢单",
  "用户已发单,工匠未接单",
  "取消接单",
  "已完成/已取消",
